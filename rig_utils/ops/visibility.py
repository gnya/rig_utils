...
class POSE_OT_rig_utils_show_overrided_bones(Operator):
    bl_idname = "pose.rig_utils_show_overrided_bones"
    ...
    def poll(cls, context: Context) -> bool:
        return (
            ...
            and context.active_object.override_library is not None
        )
    ...
    def execute(self, context: Context) -> set[OperatorReturnItems]:
        ...
        target_bones = get_overrided_bones(obj)
